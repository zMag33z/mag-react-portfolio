            ...
            <div className="WorkContent border-left">
                ...
                <div className="lgTagFloat">
                    <a href="https://zmag33z.github.io/prework-study-guide/" className="mobile" title="Pre-Work Study Guide"><img className="lgTopic" src={ images[1]} width="1526" height="856" /></a>
                        <div className="desktop">
                            <a href="https://zmag33z.github.io/prework-study-guide/" title="Pre-Work Study Guide">Click Here to View</a>
                        </div>
                </div>
                ...
                <div className="smTagFloat">
                    <a href="https://zmag33z.github.io/week-4-challenge/" className="mobile" title="Coding Quiz Challenge"><img className="smTopic" src={images[3]} width="1526" height="856" /></a>
                        <div className="desktop">
                            <a href="https://zmag33z.github.io/week-4-challenge/" title="Coding Quiz Challenge">Click Here to View</a>
                        </div>
                </div>
                ...
                <div className="smTagFloat">    
                    ...
                    <div className="desktop">
                        <a href="https://zmag33z.github.io/Week-5-Work-Day-Scheduler/" title="Work Day Scheduler">Click Here to View</a>
                    </div>
                </div>
                ...
                <div className="smTagFloat">
                    ...
                    <div className="desktop">
                        <a href="https://github.com/zMag33z/week-10-Team_Profile_Generator/" title="Team Profile Generator Applicaiton">Click Here to View</a>
                    </div>
                </div>
         ...
         <div className="WorkContent border-left">
             ...
             <div className="lgTagFloat">
                <a href="https://marchetype.github.io/the-box-project/" className="mobile" title="The Box Project"><img className="smTopic" src={images[6]} width="1526" height="856" /></a>
                     <div className="desktop">
                         <a href="https://marchetype.github.io/the-box-project/" title="The Box Project">Click Here to View</a>
                     </div>
             </div>
             ...
             <div className="smTagFloat">
                <a href="https://github.com/calebgdavidson/Rate_my_TA" className="mobile" title="Rate My Ta"><img className="smTopic" src={images[4]} width="1526" height="856" /></a>
                     <div className="desktop">
                         <a href="https://github.com/calebgdavidson/Rate_my_TA" title="Rate My Ta">Click Here to View</a>
                     </div>
             </div>
    </div>
